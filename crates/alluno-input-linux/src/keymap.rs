//! The evdev half of the key table: the neutral [`Key`] onto `KEY_*`.
...
pub fn to_evdev(key: Key) -> u16 {
    match key {
        ...
        Key::Minus => KEY_MINUS,
        Key::Equal => KEY_EQUAL,
        Key::BracketLeft => KEY_LEFTBRACE,
        Key::BracketRight => KEY_RIGHTBRACE,
        ...
        Key::NumpadSubtract => KEY_KPMINUS,
        ...
        Key::ControlRight => KEY_RIGHTCTRL,
